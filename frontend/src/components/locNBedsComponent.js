      ...
      <div className="col-lg-6 d-flex flex-column">
        ...
        <div className="row" style={{ paddingTop: '125px' }}>
          ...
          {data && data.data[0].data.map(crib =>
            <div className="cribCard col-md-5 m-2">
              <img src={crib.images.picture_url}></img>
              <div className="container p-2">
                <p style={{ fontWeight: '500' }}>{crib.address.street}</p>
                <p style={{ fontSize: '12px' }}>Beds: {crib.bedrooms} Baths: {parseInt(crib.bathrooms.$numberDecimal)}
                </p>
              </div>
